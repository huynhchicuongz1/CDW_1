...
<main>
     ...
     $time_from   = "20/10/1998";
            // cắt ngày giờ:
            $date = $flight->flight_time_from;
            $d    = strtotime($date);
            $date_to = $flight->flight_time_to;
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div><big class="time">
                                             ...
                                             $date1 = $flight->flight_time_from;
                                             $date2 = $flight->flight_time_to;
                                        ...
                                        <div class="col-sm-3 text-right">
                                            <h3 class="price text-danger"><strong><?php echo number_format($flight->flight_price) ?> VNĐ</strong></h3>
                                            <div>
                                    ...
                                    <div class="tab-content">
                                        <div id="flight-detail-tab" class="tab-pane fade in active">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <h5>
                                                        <strong class="airline"><?php echo $flight->airways_id ?> Airways QR-957</strong>
                                        ...
                                        <div id="flight-price-tab" class="tab-pane fade">
                                            <h5>
                                                <strong class="airline"><?php echo $flight->airways_id ?></strong>
                                                <p><span class="flight-class"><?php echo $flight_class ?></span></p>
                                            </h5>
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                ...
                                                <li class="list-group-item list-group-item-info">
                                                    ...
                                                    <div class="pull-right">
                                                        <strong>IDR <?php echo ($flight->flight_price*$total) ?></strong>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </li>
                                            </ul>
